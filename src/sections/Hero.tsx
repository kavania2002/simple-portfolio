      ...
      <div className="flex flex-col gap-y-12 md:gap-y-0 md:flex-row md:items-center justify-center md:justify-between h-full">
        <div className="md:flex-1 flex flex-col gap-y-1 lg:gap-y-2">
          <Reveal controls={{ delay: isMobile ? 1 : 2, hidden: { y: 50 } }}>
            <div className="-ml-[0.08em] text-[2vh] leading-[3vh] md:leading-none md:text-md lg:text-lg xl:text-xl 2xl:text-2xl text-secondary">
              Hi, I am
            </div>
          </Reveal>
          ...
          <Reveal controls={{ delay: isMobile ? 1.4 : 2.4, hidden: { y: 50 } }}>
            <div className="-ml-[0.08em] flex flex-col text-[3vh] leading-tight md:text-xl lg:text-xl xl:text-4xl 2xl:text-5xl text-tertiary-850">
              <div>Trying everything</div>
              <div>& finding happiness</div>
            </div>
          </Reveal>
