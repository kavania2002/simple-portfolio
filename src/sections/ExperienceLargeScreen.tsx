...
const Experience = () => {
  ...
  return (
    <div className="h-screen w-full px-10 md:px-24 lg:px-36 xl:px-50 2xl:px-64 py-4 md:py-8 lg:py-12 flex flex-col gap-y-6">
                ...
                (experienceData, index) =>
                  ...
                  experienceData.experiences.map((experience, index) => (
                    <div key={index} className="flex flex-col lg:gap-y-2">
                      ...
                      <ul className="list-disc text-md lg:text-[14px] xl:text-base 2xl:text-[24px] font-normal text-secondary">
